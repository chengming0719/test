...
public class MyGetMethod {
    ...
    @ApiOperation(value = "通过这个方法获取到cookie", httpMethod = "GET")
...
//      HttpServletResponse 装响应信息的类
    ...
    @ApiOperation(value = "这是一个携带参数才能访问的get请求1", httpMethod = "GET")
    ...
    @ApiOperation(value = "这是一个携带参数才能访问的get请求2", httpMethod = "GET")
